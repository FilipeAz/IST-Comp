...
namespace xpl {
class if_node; 
class apply_function_node; 
class func_invocation_node; 
...
class stop_node; 
class next_node; 
class print_line_node; 
class func_declaration_node; 
class print_node; 
class return_node; 
...
#include "ast/apply_function_node.h"
#include "ast/func_invocation_node.h"
...
#include "ast/print_line_node.h"
#include "ast/func_declaration_node.h"
...
#include "ast/var_inicialization_node.h"
