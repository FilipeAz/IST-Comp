...
namespace xpl {
  ...
  public:
    inline sweep_up_node(int lineno, cdk::lvalue_node *lvalue, cdk::expression_node *expression1, cdk::expression_node *expression2, cdk::expression_node *expression3,                 cdk::basic_node *block) :
