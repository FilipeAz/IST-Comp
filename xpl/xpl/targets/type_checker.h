// $Id: type_checker.h,v 1.9 2017/05/19 23:03:20 ist182468 Exp $ -*- c++ -*-
...
namespace xpl {
  ...
  private:
      ...
      inline void processBinaryEqNEqExpression(cdk::binary_expression_node * const node, int lvl);
      inline void processBinaryMultDivExpression(cdk::binary_expression_node * const node, int lvl);
