...
public:
  ...
  //novo
  virtual void do_var_declaration_node(xpl::var_declaration_node * const node, int lvl) = 0;
  virtual void do_var_inicialization_node(xpl::var_inicialization_node * const node, int lvl) = 0;
  virtual void do_mem_alloc_node(xpl::mem_alloc_node * const node, int lvl) = 0;
...
public:
  //novo
  virtual void do_func_definition_node(xpl::func_definition_node * const node, int lvl) = 0;
  virtual void do_func_declaration_node(xpl::func_declaration_node * const node, int lvl) = 0;
  virtual void do_func_invocation_node(xpl::func_invocation_node * const node, int lvl) = 0;
  //fim
  ...
  //novo
  virtual void do_print_line_node(xpl::print_line_node * const node, int lvl) = 0;
...
public:
  ...
  virtual void do_apply_function_node(xpl::apply_function_node * const node, int lvl) = 0;
  //fim
